...
// Client-side register validation. Backend validation still remains the source of truth for security.
...
export default function RegisterPage() {
  ...
  const usernameError = touchedFields.username
    ...
    : undefined;
  const emailError = touchedFields.email ? liveFieldErrors.email?.[0] : undefined;
