  ...
  return (
    <header className='flex items-center justify-between border-b border-app-border bg-app-bg/80 px-6 py-4 backdrop-blur'>
      ...
      <div className='flex items-center gap-3'>
        ...
        <button className='cursor-pointer rounded-xl border border-app-border px-4 py-2 text-sm font-medium text-app-muted transition hover:bg-app-card hover:text-app-text'>
