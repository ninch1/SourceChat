  ...
  return (
    <section className='rounded-3xl border border-dashed border-app-border bg-app-surface/70 px-6 py-14 text-center shadow-sm'>
      ...
      <div className='mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row'>
        <button className='inline-flex cursor-pointer items-center gap-2 rounded-xl bg-emerald-500 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-400'>
          <Plus className='h-4 w-4' />
          Add source
        </button>

        <button className='cursor-pointer rounded-xl border border-app-border px-5 py-3 text-sm font-semibold text-app-text transition hover:bg-app-card'>
          Paste text
        </button>
      </div>
    </section>
