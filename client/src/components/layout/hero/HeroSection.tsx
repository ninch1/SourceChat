  ...
  return (
    <section className="flex flex-col items-center text-center lg:items-start lg:text-left">
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-4 lg:justify-start">
        <button className="rounded-xl bg-app-primary px-5 py-3 text-sm font-semibold text-white transition hover:bg-app-primary-hover">
          Get Started
        </button>

        <button className="rounded-xl border border-app-border bg-app-surface/70 px-5 py-3 text-sm font-semibold text-app-text transition hover:bg-app-surface-soft">
          Log In
        </button>
      </div>
